...
| 固定 | START | 0 | 1 | 流程入口 |
| 固定 | END | ≥1 | 0 | 流程出口 |
| 触发 | TRIGGER | 1 | 1 | 等待信号触发 |
| 延时 | DELAY | 1 | 1 | 等待 duration_s 秒后通过 |
| 条件 | CONDITION | 1 | 2(true/false) | 计数比较 |
| 动作 | EXECUTE | 1 | 1 | 执行动作指令 |
...
| 套件 | 数量 | 状态 |
|------|:---:|:----:|
| test_api.py | 8 | ⚠️ 2 fail (pre-existing) |
| test_event_store.py | 10 | ✅ |
| test_experiment_manager.py | 9 | ✅ |
| test_export.py | 6 | ✅ |
| test_flow_schema.py | 33 | ✅ |
| test_zone_state_machine.py | 10 | ✅ |
| test_bug_regression.py | 24 | ✅ |
| test_validator_loop.py | 2 | ✅ |
| 8 ad-hoc bug tests | 8 | ⚠️ 5 need live server |
| **合计** | **134** | **127 pass** |
